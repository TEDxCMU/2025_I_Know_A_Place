            ...
            <section className={styles.container}>
                ...
                <div>
                    ...
                    <form onSubmit={addCustomPrompt}>
                        <input
                            ...
                            required
                        />
                        <button className={styles.button} disabled={!customPrompt}>
                            Add Prompt
                        </button>
                    </form>
                </div>
                ...
                {pendingStories?.map(({ id, name, email, prompt, story }) => (
                    <div key={id} className={styles.story}>
                        ...
                        <button className={styles.button} onClick={() => approveStory(id)}>
                            Approve
                        </button>
                        <button className={styles.button} onClick={() => deleteStory(id)}>
                            Deny
                        </button>
                        <br></br>
                    </div>
